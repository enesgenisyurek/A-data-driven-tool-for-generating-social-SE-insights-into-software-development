...
import com.githubIssueTrack.githubIssueTrack.githubIssue.GithubIssue;
...
public class GithubCommentController {
    ...
    public List<GithubComment> getIssueComments(@PathVariable String owner, @PathVariable String repo,@PathVariable int issue_number) {
